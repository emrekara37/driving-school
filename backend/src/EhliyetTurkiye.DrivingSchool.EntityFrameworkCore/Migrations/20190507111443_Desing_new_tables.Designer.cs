...
namespace EhliyetTurkiye.DrivingSchool.Migrations
{
    ...
    [Migration("20190507111443_Desing_new_tables")]
    partial class Desing_new_tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EhliyetTurkiye.DrivingSchool.Entities.BillPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("CoursePaymentId");
                    ...
                    b.HasIndex("CoursePaymentId");

                    b.ToTable("BillPayments");
                });

            modelBuilder.Entity("EhliyetTurkiye.DrivingSchool.Entities.CashPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EhliyetTurkiye.DrivingSchool.Entities.CourseNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EhliyetTurkiye.DrivingSchool.Entities.CoursePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EhliyetTurkiye.DrivingSchool.Entities.BillPayment", b =>
                {
                    b.HasOne("EhliyetTurkiye.DrivingSchool.Entities.CoursePayment", "CoursePayment")
                        .WithMany()
                        .HasForeignKey("CoursePaymentId")
